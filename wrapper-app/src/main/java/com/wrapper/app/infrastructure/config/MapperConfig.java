...
import com.wrapper.app.infrastructure.dto.converter.PredmetDto;
...
import com.wrapper.app.application.mapper.*;
...
import com.wrapper.app.presentation.dto.request.*;
...
public class MapperConfig {
    ...
    private void initilizePredmetConverters(ModelMapper modelMapper) {
        ...
        Converter<Predmet, com.wrapper.app.infrastructure.dto.generator.PredmetDto> predmetDtoConverter = new AbstractConverter<>() {
            @Override
            protected com.wrapper.app.infrastructure.dto.generator.PredmetDto convert(Predmet predmet) {
                return predmetMapper.map(predmet);
            }
        };
        modelMapper.addConverter(predmetDtoConverter);

        Converter<Predmet, com.wrapper.app.infrastructure.dto.generator.PredmetDto> converterPredmetDtoConverter = new AbstractConverter<>() {
            @Override
            protected com.wrapper.app.infrastructure.dto.generator.PredmetDto convert(Predmet predmet) {
    ...
    private void initilizePredavacConverters(ModelMapper modelMapper) {
        ...
        Converter<Predavac, PredavacDto> predavacDtoConverter =  new AbstractConverter<>() {
            @Override
            protected PredavacDto convert(Predavac predavac) {
                return predavacMapper.map(predavac);
            }
        };
        modelMapper.addConverter(predavacDtoConverter);

        Converter<Predavac, PredavacDto> converterPredavacDtoConverter =  new AbstractConverter<>() {
            @Override
            protected PredavacDto convert(Predavac predavac) {
    ...
    private void initilizeStudijskiProgramPredmetiConverters(ModelMapper modelMapper) {
        Converter<StudijskiProgramPredmeti, StudijskiProgramPredmetiDto> converter = new AbstractConverter<>() {
            @Override
