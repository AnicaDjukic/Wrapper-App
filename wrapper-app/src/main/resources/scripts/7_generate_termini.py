...
class RealizacijaDtoEncoder(json.JSONEncoder):
    def default(self, o):
        if isinstance(o, ReadWrite):
            return o.__dict__
...
# Create Realizacija object
realizacija = Realizacija.from_json(input_data['realizacija'])

# Create list of StudijskiProgram objects
studijskiProgramList = [StudijskiProgram.from_json(item) for item in input_data['studijskiProgramList']]

# Create list of StudijskaGrupa objects
